...
fn derive() {
    ...
    assert_eq!(
        master.0,
        vec![
            0x19, 0xE8, 0xD5, 0x50, 0xE3, 0xA7, 0x99, 0xB2, 0x91, 0x7B,
            0xC5, 0x91, 0x46, 0xAA, 0xAD, 0xAE,
        ]
    )
}
...
fn mac() {
    ...
    assert_eq!(
        mac,
        [
            0x5F, 0x08, 0xF1, 0x9A, 0x7D, 0x6D, 0x8A, 0xCE, 0xB7, 0xA6, 0x95, 0x5B, 0x15,
            0x33, 0x17, 0x3C, 0xDD, 0x34, 0x20, 0x39, 0xD4, 0xF7, 0x6A, 0x11, 0x7F, 0xE1,
            0xAA, 0xAA, 0xB7, 0xB2, 0x7F, 0xEC
        ]
    )
}
